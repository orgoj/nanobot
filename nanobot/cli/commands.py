...
""")
    ...
    # Create FAILURES.md
    failures_file = workspace / "FAILURES.md"
    if not failures_file.exists():
        failures_file.write_text("# Failure Log\n\nLog your mistakes here to learn from them.\n")
        console.print("  [dim]Created FAILURES.md[/dim]")
...
def gateway(
    ...
    heartbeat = HeartbeatService(
        ...
        interval_s=config.agents.defaults.heartbeat_interval,
        enabled=True,
    )
