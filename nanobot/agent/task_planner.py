...
"""
        ...
        try:
            ...
            for data in sub_goals_data:
                ...
                sub_goal = Goal(
                    ...
                    metadata={"complexity": data.get("complexity", 3), "parent_goal": goal.id},
                )
    ...
    def update_task_status(
        self, plan_id: str, task_id: str, status: str, result: str = None
    ) -> bool:
    ...
    async def suggest_optimizations(
        self, goal_description: str, previous_results: List[str] = None, model: str = None
    ) -> Dict[str, Any]:
