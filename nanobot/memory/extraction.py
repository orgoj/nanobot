...
from nanobot.memory.models import Edge, Entity, Event, Fact
...
class Gliner2Extractor:
    ...
    def _convert_relation(
        self, gliner_relation: dict, event: Event, entities: list[Entity]
    ) -> Optional[Edge]:
    ...
    def _extract_facts(self, text: str, event: Event, entities: list[Entity]) -> list[Fact]:
