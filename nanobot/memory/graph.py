...
from nanobot.memory.models import Edge, Entity, Fact
...
class KnowledgeGraphManager:
    ...
    def deduplicate_fact(self, fact: Fact) -> Optional[Fact]:
        ...
        for existing in existing_facts:
            ...
            if existing.predicate == fact.predicate and self._similar_objects(
    ...
    def get_entity_network(self, entity_id: str, depth: int = 1, min_strength: float = 0.5) -> dict:
        """
    ...
    def find_similar_entities(self, entity_id: str, threshold: float = 0.7) -> list[Entity]:
        ...
        similar = self.store.search_similar_entities(
            entity.embedding, limit=10, threshold=threshold
        )
