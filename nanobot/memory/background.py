...
class BackgroundProcessor:
    ...
    async def _extract_pending_events(self) -> int:
        ...
        """
        from nanobot.memory.extraction import ExtractionConfig, extract_entities
                ...
                for entity in result.entities:
                    ...
                    if existing:
                        ...
                        existing.source_event_ids = list(
                            set(existing.source_event_ids + entity.source_event_ids)
                        )
    ...
    async def _decay_learnings(self) -> int:
        ...
        try:
            ...
            if stats["decayed"] > 0 or stats["removed"] > 0:
                logger.info(
                    f"Learning decay applied: {stats['decayed']} decayed, {stats['removed']} removed"
                )
