...
class LearningManager:
    ...
    async def _check_contradictions(self, new_learning: Learning) -> bool:
        ...
        for old in existing:
            ...
            similarity = self._calculate_similarity(new_learning.content, old.content)
    ...
    def get_relevant_learnings(self, topic: str = None, limit: int = 10) -> list[Learning]:
        ...
        learnings.sort(key=lambda learning: learning.relevance_score, reverse=True)

        return learnings[:limit]


def create_learning_manager(
    store: TurboMemoryStore, embedding_provider: Optional[EmbeddingProvider] = None, **kwargs
) -> LearningManager:
