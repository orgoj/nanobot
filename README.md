...
| `zai` | LLM (Z.AI Coding Plan, GLM-4.7) | [z.ai](https://z.ai) |
...
|--------|---------|-------------|
| `agents.defaults.startup_prompt` | `null` | A prompt executed by the agent immediately upon starting the gateway. |
