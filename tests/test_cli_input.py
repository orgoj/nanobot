...
def test_init_prompt_session_creates_session():
    ...
    with patch("nanobot.cli.commands.PromptSession") as mock_session_cls, patch(
        "nanobot.cli.commands.FileHistory"
    ) as _mock_history_cls, patch("pathlib.Path.home") as mock_home:
